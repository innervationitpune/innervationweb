        ...
        <div className="h-[100vh] bg-white items-center flex justify-center px-5 lg:px-0">
          <div className="w-[415px] text-center flex-col items-center justify-center mx-auto gap-[100px]">
            <div className="mb-8 md:mb-[56px]">
              ...
              <img src={Image} alt="404" className="w-full h-full object-contain" />
              </div>
            </div>
            <div>
            ...
            <div className="flex flex-col gap-6 mt-3">
              ...
              <div>
                <button className="bg-[#8AC732] text-white font-sans max-w-[146px] w-full h-[48px] rounded-[100px] font-medium text-sm" onClick={() => navigate("/")}>
                  Home Page
                </button>
              </div>
            </div>
